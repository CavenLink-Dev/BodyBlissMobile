...
export const THERAPISTS: Therapist[] = [
  ...
  },
  {
    ...
    name: "Daniel",
    gender: "male",
    specialties: ["deep_tissue", "remedial", "corporate"],
    yearsExperience: 10,
    languages: ["English"],
    rating: 4.8,
    reviewCount: 189,
  ...
  },
  {
    ...
    name: "Tom",
    gender: "male",
    specialties: ["deep_tissue", "corporate", "hotel"],
    yearsExperience: 5,
    languages: ["English"],
    rating: 4.7,
    reviewCount: 121,
    ...
    shortBio:
      "Friendly and efficient — a favourite for workplace chair massage days.",
    bio: "Tom splits his week between home visits and corporate chair massage, where his relaxed, friendly manner puts whole offices at ease. His deep tissue work is focused and effective, and he's a great pick if you like a firmer touch without the small talk.",
  },
  {
    id: "hana",
    name: "Hana",
  ...
  },
  {
    ...
    name: "Marco",
    gender: "male",
    specialties: ["deep_tissue", "remedial", "couples", "corporate"],
    yearsExperience: 9,
