/*
  ...
  brand palette (porcelain, bliss-gold, espresso, charcoal). Lives on the
...
export function HeroIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* soft porcelain glow behind the scene */}
      <ellipse cx="210" cy="160" rx="190" ry="120" fill="hsl(60 21% 94%)" opacity="0.08" />

      {/* window with night sky + moon (we come to you, evenings too) */}
      <rect x="288" y="38" width="96" height="118" rx="8" fill="hsl(60 21% 94%)" opacity="0.12" />
      <rect x="296" y="46" width="80" height="102" rx="4" fill="hsl(43 6% 16%)" />
      <circle cx="352" cy="72" r="12" fill="hsl(49 96% 47%)" opacity="0.9" />
      <circle cx="316" cy="96" r="2" fill="hsl(60 21% 94%)" opacity="0.7" />
      <circle cx="332" cy="118" r="1.6" fill="hsl(60 21% 94%)" opacity="0.5" />
      <circle cx="312" cy="128" r="1.6" fill="hsl(60 21% 94%)" opacity="0.6" />
      ...
      <g>
        ...
        <path
          ...
          fill="hsl(152 40% 38%)"
        />
        <path d="M52 174h28l-5 44H57l-5-44z" fill="hsl(49 96% 47%)" />
        <rect x="50" y="172" width="32" height="8" rx="3" fill="hsl(43 6% 30%)" />
      </g>

      {/* aromatherapy wisps rising from the oil burner */}
      <g stroke="hsl(60 21% 94%)" strokeWidth="2.4" strokeLinecap="round" fill="none">
      ...
      {/* oil burner / candle */}
      <rect x="322" y="208" width="36" height="12" rx="4" fill="hsl(49 96% 47%)" />
      ...
      <g>
        ...
        />
        {/* head */}
        <circle cx="154" cy="92" r="15" fill="hsl(60 21% 94%)" />
        {/* hair bun */}
      ...
      <g>
        ...
        />
        {/* head on the cradle */}
        <circle cx="352" cy="186" r="12" fill="hsl(60 21% 94%)" opacity="0.95" />
        <path d="M344 178c6-4 14-2 17 3-5-1-11 0-14 4l-3-7z" fill="hsl(43 6% 16%)" />
        {/* gold trim on the towel */}
        <rect x="188" y="192" width="150" height="4" fill="hsl(49 96% 47%)" />
      </g>
      ...
      <g>
        ...
        {/* folding legs */}
        <path d="M198 208l-14 54h9l14-54h-9z" fill="hsl(60 21% 94%)" opacity="0.85" />
        <path d="M214 208l14 54h-9l-14-54h9z" fill="hsl(60 21% 94%)" opacity="0.85" />
        <path d="M330 208l-14 54h9l14-54h-9z" fill="hsl(60 21% 94%)" opacity="0.85" />
        <path d="M346 208l14 54h-9l-14-54h9z" fill="hsl(60 21% 94%)" opacity="0.85" />
        {/* leg cross-braces */}
        <rect x="192" y="238" width="48" height="4" rx="2" fill="hsl(60 21% 94%)" opacity="0.5" />
        <rect x="324" y="238" width="48" height="4" rx="2" fill="hsl(60 21% 94%)" opacity="0.5" />
      </g>

      {/* therapist's carry bag — the "mobile" in mobile massage */}
      <g>
        <rect x="86" y="234" width="52" height="30" rx="6" fill="hsl(49 96% 47%)" />
        <path
      ...
      {/* floor line */}
      <rect x="40" y="262" width="344" height="4" rx="2" fill="hsl(60 21% 94%)" opacity="0.25" />
    </svg>
  );
}
